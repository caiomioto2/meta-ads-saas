...
import { usePrompts, useDeletePrompt } from "@decocms/sdk";
import { isWellKnownPromptId } from "@decocms/sdk/constants";
...
export function DocumentsResourceList({
  ...
  if (activeTab === "prompts") {
    const handlePromptClick = (item: Record<string, unknown>) => {
      const prompt =
        (item._prompt as import("@decocms/sdk").Prompt) ||
        (item as unknown as import("@decocms/sdk").Prompt);
