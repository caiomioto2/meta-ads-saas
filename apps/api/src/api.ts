...
import { DECO_CHAT_KEY_ID, getKeyPair } from "@decocms/sdk/auth";
import {
  AGENT_TOOLS,
  ...
  wrapToolFn,
  createToolGroup,
} from "@decocms/sdk/mcp";
import { getApps, getGroupByAppName } from "@decocms/sdk/mcp/groups";
import { executeTool } from "@decocms/sdk/mcp/tools/api";
