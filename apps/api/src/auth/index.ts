import { getUserBySupabaseCookie } from "@decocms/sdk/auth";
import { createSupabaseClient } from "@decocms/sdk/storage";
import type {
  EmailOtpType,
  Provider,
  User as SupaUser,
...
import { assertPrincipalIsUser } from "@decocms/sdk/mcp";
